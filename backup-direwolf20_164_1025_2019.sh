...
echo "===== Starting $backupStamp Backup ====="
# We need to first put the server in readonly mode to reduce the chance of backing up half of a chunk.
screen -p 0 -S $serverNick -X eval "stuff \"save-off\"\015"
screen -p 0 -S $serverNick -X eval "stuff \"save-all\"\015"
screen -p 0 -S $serverNick -X eval "stuff \"say Backup starting.\"\015"
